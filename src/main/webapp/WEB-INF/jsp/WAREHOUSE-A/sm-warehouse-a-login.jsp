...
<body class="cui-config-borderless cui-menu-colorful" style="background-image:url(../components/dummy-assets/common/img/bg.jpg); background-size:cover;">
...
<div
  class="cui-login"
  style="background-image: url(../components/pages/common/img/login/1.jpg)"
>
      ...
      <div class="col-xl-12">
        <div class="cui-login-block-inner">
          <div class="cui-login-block-form">
            ...
            <form id="form-validation" name="form-validation" method="POST">
              ...
              <div class="form-actions">
               <button class="btn btn-primary mr-3"><a href="sm-warehouse-a-dashboard.html" style="color:FFF">Sign In</a></button>
          ...
          <div class="cui-login-block-sidebar">
            ...
            <img src="../components/dummy-assets/common/img/logo-sanjray.png" width="154" height="82"> <strong>Material Tracking System
</strong>
              <br />
   
            </h4>
            <div class="cui-login-block-sidebar-item" style="border:0px">
             <img src="../components/dummy-assets/common/img/gps.png">
            </div>
